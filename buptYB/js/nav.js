...
var strArray = new Array("#","index.php","school.html","mapbb.html","maphh.html","recent.html","register.php","safe.html","note.html"); //网址数组
...
if (parseInt(Cookies.get("done")) != 1) { //处理上一页/下一页的指向地址
    ...
    if (pos>=0) {
        var prevLink = pos-1;
        if (currLink == "note.html") var nextLink = 1;
